...
<body>
	<header>
		<div id="container">
			<div class="title">
				<h1>Muzika privalo išskelti ugnį iš žmogaus sielos.Muzika
					negali mąstyti, bet ji gali įkūnyti mintį</h1>
			</div>
		...
		<div class="blokas">
			...
			<select class="selectBox">
				...
				<form:form action="sersas" modelAttribute="filtras" method="POST">
					<form:label path="inputText">Paieska</form:label>
					...
					<select class="selectBox">
						...
						<option value="2">Dainos pavadinimas</option>
